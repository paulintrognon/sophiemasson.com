...
function bbcode_js()
{
	...
	$js .= '{';
	$js .= 'var pagedesti = \'http://www.sophiemasson.com/upload/index.php\';';
	$js .= 'window.open(pagedesti,\'image\',\'width=720, height=500, statut=1, toolbar=0, location=0, menubar=0, scrollbars=1\');';
	$js .= '}';
	$js .= 'else if (nature == "pdf")';
	$js .= '{';
	$js .= 'var pagedesti = \'https://www.la-plate-forme.com/Upload/upload-docs.php\';';
	$js .= 'window.open(pagedesti,\'image\',\'width=500, height=400, statut=0, toolbar=0, location=0, menubar=0\');';
	$js .= '}';
