<div class="portrait-perso" id="portrait-sophie">
    ...
    <p class="portrait-text">
        ...
        ainsi que des projets évènementiels Lancôme, Réunion des musées nationaux,
...
<div class="portrait-perso" id="portrait-valerie">
    ...
    <p class="portrait-text">
        ...
        Après un passage dans le monde de la mode, et toujours avide de
        nouveautés, Valérie s'affirme dans le domaine de la communication.<br />
        Devenue Directeur Artistique en Agence,
        Valérie collabore avec des grands noms de la déco:
